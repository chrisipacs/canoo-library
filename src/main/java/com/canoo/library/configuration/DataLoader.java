...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        bookRepository.save(new Book("The Lord of the Rings", "J. R. R. Tolkien", LocalDate.now(), "", lordOfTheRingsDescription, List.of(Genre.FANTASY)));
        bookRepository.save(new Book("The Hitchiker's guide to the Galaxy", "Douglas Adams", LocalDate.now(), "","",List.of(Genre.SF)));
        bookRepository.save(new Book("1984", "George Orwell", LocalDate.now(), "","",List.of(Genre.DYSTOPIA,Genre.DRAMA)));
        bookRepository.save(new Book("Catch-22", "Joseph Heller", LocalDate.now(), "","",List.of(Genre.SATIRE,Genre.FICTION,Genre.DRAMA)));
        ...
        bookRepository.save(new Book("A Storm of Swords", "George R. R. Martin", LocalDate.now(), "","",List.of(Genre.FANTASY)));
        bookRepository.save(new Book("Calvin and Hobbes", "Bill Watterson", LocalDate.now(), "0740748475",calvinAndHobbesDescription,List.of(Genre.COMICS)));
    }
}
